...
public final class ModBlock {
    ...
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_1M = block("1M Crafting Storage", "1m_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_1M), () -> ModItem.CELL_COMPONENT_1M);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_4M = block("4M Crafting Storage", "4m_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_4M), () -> ModItem.CELL_COMPONENT_4M);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_16M = block("16M Crafting Storage", "16m_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_16M), () -> ModItem.CELL_COMPONENT_16M);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_64M = block("64M Crafting Storage", "64m_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_64M), () -> ModItem.CELL_COMPONENT_64M);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_256M = block("256M Crafting Storage", "256m_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_256M), () -> ModItem.CELL_COMPONENT_256M);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_1G = block("1G Crafting Storage", "1g_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_1G), () -> ModItem.CELL_COMPONENT_1G);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_4G = block("4G Crafting Storage", "4g_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_4G), () -> ModItem.CELL_COMPONENT_4G);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_16G = block("16G Crafting Storage", "16g_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_16G), () -> ModItem.CELL_COMPONENT_16G);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_64G = block("64G Crafting Storage", "64g_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_64G), () -> ModItem.CELL_COMPONENT_64G);
    public static final BlockDefinition<CraftingUnitBlock> STORAGE_256G = block("256G Crafting Storage", "256g_crafting_storage", () -> new CraftingUnitBlock(ReinforcedCraftingUnitType.STORAGE_256G), () -> ModItem.CELL_COMPONENT_256G);

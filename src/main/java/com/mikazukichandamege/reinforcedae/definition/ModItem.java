...
public final class ModItem {
    ...
    public static final RegistryObject<Item> SPEED_CARD = item("speed_card", Upgrades::createUpgradeCardItem);
    public static final RegistryObject<Item> ENERGY_CARD = item("energy_card", p -> new EnergyCardItem(p, 5));

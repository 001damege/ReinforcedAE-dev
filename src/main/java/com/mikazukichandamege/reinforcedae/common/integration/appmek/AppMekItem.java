...
public final class AppMekItem {
    public static final ItemDeferredRegistries<MaterialItem> CHEMICAL_CELL_HOUSING = RAEItem.item("Reinforced Chemical Cell Housing", "rnf_chemical_cell_housing", MaterialItem::new);
}

...
public final class AppFluxItem {
    public static final ItemDeferredRegistries<MaterialItem> FLUX_CELL_HOUSING = RAEItem.item("Reinforced Flux Cell Housing", "rnf_flux_cell_housing", MaterialItem::new);
}

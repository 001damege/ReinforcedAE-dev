...
public class ItemOverSourceCell extends AEBaseItem implements ISourceCellItem {

    public ItemOverSourceCell(Properties properties) {
        ...
        if (InteractionUtil.isInAlternateUseMode(player)) {
            ...
            if (inventory != null && playerInventory.getSelected() == stack) {
                ...
                if (list.isEmpty()) {
                    ...
                    playerInventory.placeItemBackInInventory(new ItemStack(ArsItem.SOURCE_CELL_HOUSING.get()));
                    return true;
                } else {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        SourceCellHandler.INSTANCE.addCellInformationToTooltip(pStack, pTooltipComponents);
    }
}

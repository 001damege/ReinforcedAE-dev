package com.mikazukichandamege.reinforcedae.integration.mekanism;
...
public final class MekanismItem {
    ...
    public static final RegistryObject<Item> CHEMICAL_CELL_HOUSING = item("reinforced_chemical_cell_housing", MaterialItem::new);

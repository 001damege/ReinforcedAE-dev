...
public class ItemDeferredRegistries<T extends Item> implements ItemLike, Supplier<T> {
    private final String englishName;
    private final RegistryObject<T> item;

    public ItemDeferredRegistries(String englishName, RegistryObject<T> item) {
